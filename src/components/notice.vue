  ...
  export default {
    ...
    methods: {
      ...
      load() {
        ...
        var postdata = { category: 2, page: that.currentPage, pagesize: that.pagesize }
      ...
      gofor(index) {
        location.href = 'notice-detail.html?id=' + index
      },
      getYear(dateObject) {
        if (dateObject != null) {
...
<style scoped>
  ...
  @media (min-width: 768px) {
    .news-list { max-width: 1000px; width: 100%; margin: 0 auto; }
